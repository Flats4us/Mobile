...
import com.example.flats4us.adapters.ImageSliderAdapter
import com.example.flats4us.data.MapOffer
import com.example.flats4us.data.utils.Constants.Companion.OFFER_ID
import com.example.flats4us.databinding.FragmentMapBinding
...
class MapFragment : Fragment() {
    ...
    private fun showDialog(offerId: Int) {
        ...
        viewModel.offer.observe(viewLifecycleOwner) { offer ->
            ...
            startDate.text = offer.dateIssue.split('T')[0]
            endDate.text = offer.dateIssue.split('T')[0]
